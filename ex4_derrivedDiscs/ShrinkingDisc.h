...
public:
    ShrinkingDisc(double x1, double y1, double vx, double vy, double radius,int lives_count=0,bool is_shrinked= false);
...
private:
    ...
    bool is_shrinked; // flag to indicate if the disc already shrinked once.
    Disc_Type discType;
};
